...
def Getfilename():
    root.filename =  filedialog.askopenfilename(initialdir = "C:\" " ,title = "Select file",filetypes = (("Img files",(("*.jpg"),("*.png"))),("png files","*.png")))
...
def callEncoder():
    if (Output['text'] == "\nReady To Compress\n"):
        ...
        call( ["python", "JPEGEncoderFinal.py"] + param1+param2, shell=False )
    else:
        # if(Output['text'][0] != 'P'):
